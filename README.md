# my_project#details are downloade from github
...
to the `./samples` folder:
        ...
        perl bin/createsamples.pl positives.txt negatives.txt samples 6000\
          "opencv_createsamples -bgcolor 0 -bgthresh 0 -maxxangle 1.1\
          -maxyangle 1.1 maxzangle 0.6 -maxidev 40 -w 50 -h 50 "
...
- [OpenCV Documentation - Cascade Classifier Training](http://docs.opencv.org/doc/user_guide/ug_traincascade.html)
        ...
        opencv_traincascade -data classifier -vec samples.vec -bg negatives.txt\
          ...
          -numNeg 1500 -w 50 -h 50 -mode ALL -precalcValBufSize 1024\
          -precalcIdxBufSize 1024 -featureType LBP
